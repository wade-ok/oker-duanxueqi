<template>
  <el-card class="bod-card">
    ...
    <el-table-column prop="address" label="查看"  fixed="right" align="center">
      ...
      <el-table-column prop="address" label="验收"  fixed="right" align="center">
        <template slot-scope="scope">
            <el-button
              size="mini"
              plain
    ...
    height="400">
      ...
      <el-table-column prop="username" label="开发人" align="center"></el-table-column>
       <el-table-column prop="starttime" label="开始时间"  width="205" align="center"></el-table-column>
       <el-table-column prop="endtime" label="结束时间"  width="205" align="center"></el-table-column>
      ...
      <div slot="footer" class="dialog-footer" align="center"> 
        ...
        <el-dialog
          ...
          center
          append-to-body>
          <span style="width:100%;text-align:center;display:block;">确定项目要验收该项目吗？</span>
          <span slot="footer" class="dialog-footer">
             <el-button type="primary" @click="acceptance(form)">确 定</el-button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
export default {
  ...
  methods: {
      ...
      acceptance(form){
        this.$http.post('http://localhost:8081/projects/Checkprojects',this.form)
      .then((res)=>{
          console.log(res)
          const {
              code,
    ...
    //搜索功能
    async searchLeave() {
    this.$http.get(`http://localhost:8081/projects/getProfourList/${this.query}`)
    .then((res)=>{
        console.log(res)
        const {
            code,
    ...
    //获取请假数据
    async getLeaveList() {
      this.$http.post('http://localhost:8081/projects/waitcheckprojects')
      .then((res)=>{
          console.log(res)
          const {
              code,
