<template>
  <el-card class="bod-card">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>待验收项目列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索 -->
    ...
    height="400">
      ...
      <el-table-column prop="sendname" label="发包方" width="100" align="center"></el-table-column>
      <el-table-column prop="proname" label="项目名称" align="center" width="100"></el-table-column> 
      <el-table-column prop="pstarttime" label="开始时间" width="180" align="center"></el-table-column>
      <el-table-column prop="pendtime" label="完成时间" width="180" align="center"></el-table-column>
      <el-table-column prop="expecttime" label="期望完成时间" width="180" align="center"></el-table-column>
      <el-table-column prop="pfactdays" label="实际人天" width="100" align="center"></el-table-column>
      <el-table-column prop="pexpectdays" label="预计人天" width="100" align="center"></el-table-column>
      <el-table-column prop="devnumbers" label="开发人数" width="100" align="center"></el-table-column>
      <el-table-column prop="pstate" label="状态" width="100" align="center"></el-table-column>
    ...
    height="400">
      ...
      <!-- <el-table-column prop="pid" label="项目ID" align="center" ></el-table-column> -->
      <el-table-column prop="taskname" label="任务名称" width="155" align="center"></el-table-column> 
...
export default {
  ...
  methods: {
    ...
    //搜索功能
    async searchLeave() {
    this.$http.get(`http://localhost:8081/projects/getreProfourList/${this.query}`)
    .then((res)=>{
        console.log(res)
        const {
            code,
    ...
    //获取请假数据
    async getLeaveList() {
      this.$http.post('http://localhost:8081/projects/rewaitchecks')
      .then((res)=>{
          console.log(res)
          const {
              code,
