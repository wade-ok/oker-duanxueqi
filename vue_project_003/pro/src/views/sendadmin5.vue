<template>
  <el-card class="bod-card">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>正在开发中目列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索 -->
    ...
    <el-dialog title="开 发 中 项 目" :visible.sync="dialogFormVisibleEdit">
      <el-form :model="form">
        ...
        <el-form-item label="" label-width="100px">
            ...
            <el-col :span="7"> 
                <el-input  disabled v-model="form.pexpectdays" autocomplete="off" placeholder="开发任务书"></el-input>
            </el-col>

            <el-col :span="1"> &nbsp; </el-col>
            <el-col :span="3"> 实&nbsp; 际&nbsp; 人&nbsp; 天： </el-col>
            <el-col :span="7"> 
                <el-input  disabled v-model="form.pfactdays" autocomplete="off" placeholder="已完成任务数"></el-input>
            </el-col>
        </el-row>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    //搜索功能
    async searchLeave() {
    this.$http.get(`http://localhost:8081/projects/getProthreeList/${this.query}`)
    .then((res)=>{
        console.log(res)
        const {
            code,
    ...
    //获取请假数据
    async getLeaveList() {
      this.$http.post('http://localhost:8081/projects/devingprojects')
      .then((res)=>{
          console.log(res)
          const {
              code,
