<template>
  <el-card class="bod-card">
    ...
    height="400">
      ...
      <!-- <el-table-column prop="tstate" label="下载" align="center"></el-table-column> -->
    </el-table>
...
export default {
  ...
  methods: {
    ...
    //搜索功能
    async searchLeave() {
    this.$http.get(`http://localhost:8081/projects/getreProfiveList/${this.query}`)
    .then((res)=>{
        console.log(res)
        const {
            code,
    ...
    //获取请假数据
    async getLeaveList() {
      this.$http.post('http://localhost:8081/projects/rewaitcheckeds')
      .then((res)=>{
          console.log(res)
          const {
              code,
